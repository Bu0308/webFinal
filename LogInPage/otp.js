...
function sendOTP() {
  ...
  localStorage.setItem('generatedOTP', otp); // SAVE the generated OTP locally ✅
...
function verifyOTP() {
  ...
  const correctOTP = localStorage.getItem('generatedOTP'); // or however you store it
  ...
  if (enteredOTP === correctOTP) {
    ...
    // Redirect to new_password.html after a short delay
    setTimeout(() => {
